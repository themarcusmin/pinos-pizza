                    ...
                    <form onSubmit={handleSubmit} className="relative grid bg-yellow-200 grid-cols-8 md:gap-3 gap-y-4 md:w-4/5 max-h-full w-5/6 m-auto rounded-lg py-3 shadow-2xl space-y-0 md:space-y-2 md:py-4">
                        ...
                        <div className="col-start-2 col-end-8">
                            <label htmlFor="password" className="block text-sm font-medium text-gray-700">
                                Password
                                <input required type="password" ref={passwordRef} autoComplete="off" className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                            </label>
                        </div>
                        ...
                        <Link to="/forgot-password" className="col-start-1 col-end-9 justify-self-center text-gray-600 hover:text-black cursor-pointer">
